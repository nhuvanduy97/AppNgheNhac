...
public class PlayNhacActivity extends AppCompatActivity {
    ...
    private TextView textViewTimeSong, textViewTotalSong;
    private SeekBar seekBarTime;
    private ImageButton imgPlay, imgRepeat, imgPre, imgRandom, imgNext;
    private ViewPager viewPagerPlayNhac;
    public static ArrayList<BaiHat> mangBaiHat = new ArrayList<>();
    public static ViewPagerPlayListNhac adapterNhac;
    private Fragment_DiaNhac fragment_diaNhac = new Fragment_DiaNhac();
    private Fragment_PlayDanhSachBaiHat fragment_playDanhSachBaiHat = new Fragment_PlayDanhSachBaiHat();
